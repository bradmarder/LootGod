		...
		<Popover>
			...
			<Popover.Body>
				<ListGroup horizontal>
					...
					<ListGroup.Item className='flex-fill text-end'>{data.rank}</ListGroup.Item>
				</ListGroup>
				<ListGroup horizontal>
					<ListGroup.Item className='text-info'>Class</ListGroup.Item>
					<ListGroup.Item className='flex-fill text-end'>{classes[data.class]}</ListGroup.Item>
				</ListGroup>
				<ListGroup horizontal>
					<ListGroup.Item className='text-info'>Level</ListGroup.Item>
					<ListGroup.Item className='flex-fill text-end'>{data.level || '-'}</ListGroup.Item>
				</ListGroup>
				<ListGroup horizontal>
					<ListGroup.Item className='text-info'>Last On Date</ListGroup.Item>
					<ListGroup.Item className='flex-fill text-end'>{data.lastOnDate || '-'}</ListGroup.Item>
				</ListGroup>
				<ListGroup horizontal>
					<ListGroup.Item className='text-info'>Zone</ListGroup.Item>
					<ListGroup.Item className='flex-fill text-end'>{data.zone || '-'}</ListGroup.Item>
				</ListGroup>
				<ListGroup horizontal>
					<ListGroup.Item className='text-info'>Granted T1 Raid Loots</ListGroup.Item>
					<ListGroup.Item className='flex-fill text-end'>{data.t1GrantedLootCount}</ListGroup.Item>
				</ListGroup>
				<ListGroup horizontal>
